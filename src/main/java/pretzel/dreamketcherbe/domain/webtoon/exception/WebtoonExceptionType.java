...
public enum WebtoonExceptionType implements ExceptionType {
    ...
    UNAUTORIZED_MEMBER(HttpStatus.UNAUTHORIZED, "작성자만 가능합니다."),
    ...
    TAG_NOT_FOUND(HttpStatus.NOT_FOUND, "해당 태그는 존재하지 않습니다."),
    ALREADY_EXIST_TAG(HttpStatus.BAD_REQUEST, "이미 존재하는 태그입니다."),
