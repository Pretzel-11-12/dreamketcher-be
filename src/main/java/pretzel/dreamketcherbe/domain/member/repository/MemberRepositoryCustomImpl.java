...
import pretzel.dreamketcherbe.domain.member.dto.WorkContentWithStatusDto;
...
public class MemberRepositoryCustomImpl implements MemberRepositoryCustom {
    ...
    // TODO: 추후 위 findAllWorkWithPage 와 통합
    @Override
    public WorkResDto findAllWorkWithPageWithStatus(Long memberId, String status,
        PageReqDto pageReqDto) {
        List<WorkContentWithStatusDto> content = getWorksWithStatus(memberId, status, pageReqDto);
        long total = getTotalDataCount(memberId, status);
     ...
     * TODO: 추후 위 findAllWorkWithPage 와 통합
     */
    private List<WorkContentWithStatusDto> getWorksWithStatus(Long memberId, String status,
        PageReqDto pageReqDto) {
        return jpaQueryFactory.select(
                Projections.constructor(WorkContentWithStatusDto.class,
                    webtoon.id,
                    webtoon.title,
                    webtoon.thumbnail,
                    member.nickname,
