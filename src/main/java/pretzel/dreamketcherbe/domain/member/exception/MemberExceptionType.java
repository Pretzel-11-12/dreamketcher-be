...
public enum MemberExceptionType implements ExceptionType {
    ...
    BUSINESS_EMAIL_ALREADY_EXISTS(HttpStatus.BAD_REQUEST, "이미 존재하는 비즈니스 이메일입니다."),
    ALREADY_FAVORITED(HttpStatus.BAD_REQUEST, "이미 관심 웹툰으로 등록된 웹툰입니다."),
    ALREADY_SUSPENDED(HttpStatus.BAD_REQUEST, "이미 정지된 회원입니다."),
    NOT_SUSPENDED(HttpStatus.BAD_REQUEST, "정지된 회원이 아닙니다.");
